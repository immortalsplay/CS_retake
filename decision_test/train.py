...
# This parameters are from imageNet average, which are not suitable for real CSGO environment. Actually performance is bad.
...
class MyDataset(Dataset):
    def __init__(self, root_dir, names_file, transform=None):
        ...
        self.names_file = names_file  # meta.csv path
        self.transform = transform  # pretrain 
        self.size = 0           # video num
        self.names_list = []  # meta.csv file
        self.data_ram = []
        self.out_ram = []
        # reading from meta
        ...
        # outs = [res for res in multiple_results]  # take 4 ouput (inputs, labels_tensor)
...
if __name__ == '__main__':
                ...
                try:
                    ...
                    have_previous = True
                    net = Net(have_previous).half()  # 16 accuray training
                ...
                for epoch in range(epoch_num):
                    ...
                    for inputs,labels_tensor in data_loader:
                        ...
                        # # image : 800*600*3*4*/1000000000 = XGB
